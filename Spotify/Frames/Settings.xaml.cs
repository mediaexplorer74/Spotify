...
namespace Spotify.Frames
{
    ...
    public sealed partial class Settings : Page
    {
        ...
        {
            await Launcher.LaunchUriAsync(new Uri("https://github.com/aboe026/Spotify"));
        }
        ...
        {
            await Launcher.LaunchUriAsync(new Uri("https://github.com/aboe026/Spotify/tree/master/PRIVACY.md"));
        }
